...
def initialize_memory_file() -> list[str]:
    ...
    lines.append("        node_addresses_write    : in  std_logic_vector(node_address_size - 1 downto 0);")
...
def finalize_memory_file(lines: list[str]) -> list[str]:
    ...
    lines.append("                ram_data(to_integer((i * node_address_size) + unsigned(node_addresses_write(node_address_size - 1 downto 0)))) ")
    lines.append("                        <= ")
...
def initialize_testbench() -> list[str]:
    ...
    lines.append("signal addresses_to_write   : std_logic_vector(levels_in_memory - 1 downto 0);")
    ...
    lines.append("            addresses_to_write  => addresses_to_write,")
