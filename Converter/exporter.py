...
def export_memory_block(
    tree: list[Node], filepath: Path, threshold_lenght: int, feature_lenght: int
) -> None:
            ...
            if node.valid_bit:
                ...
                if node.leaf:
                    ...
                    threshold = bin_fixed_len(
                        node.threshold * pow(2, 16), threshold_lenght
                    )  # to simulate float as integer
